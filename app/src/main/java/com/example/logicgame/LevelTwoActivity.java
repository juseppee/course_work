...
public class LevelTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textEnd.setText(R.string.leveltwoEnd);
        ...
        final Animation a = AnimationUtils.loadAnimation(LevelTwoActivity.this, R.anim.alpha);
    ...
    public void onResume() {
        ...
        Cursor query = db.rawQuery("SELECT * FROM tasks WHERE theme = 2;", null);
